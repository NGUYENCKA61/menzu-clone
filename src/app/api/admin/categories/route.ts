...
/**
 * "Valorant Random" -> "valorant-random". The slug is the public URL segment,
 * so it is derived rather than typed: a stray space or capital there is a
 * broken link, not a cosmetic slip.
 */
