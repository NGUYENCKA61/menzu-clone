    ...
    <>
      ...
      <div className="relative" ref={wrapper}>
        <button
          ...
          className="flex h-9 items-center gap-2 sm:gap-2.5 px-1 sm:px-2 rounded-[10px] border border-[#2b2b31] bg-[#08080b] hover:border-white/20 hover:bg-[#131318] transition-colors"
        >
