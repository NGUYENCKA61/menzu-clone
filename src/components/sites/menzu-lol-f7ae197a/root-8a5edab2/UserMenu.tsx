    ...
    <>
      ...
      <div className="relative" ref={wrapper}>
        <button
          ...
          className="flex h-9 items-center gap-2 sm:gap-2.5 px-1 sm:px-2 rounded-[10px] border border-[#3a3a44] bg-[#2a2a32] hover:border-white/20 hover:bg-[#343440] transition-colors"
        >
        ...
        {open ? (
          // Narrow. The widest thing in here is a username or "Lịch
          // sử giao dịch"; at 340px a third of every row sat empty.
          // Right-anchored and dropped from the same top edge as the notification
          ...
          <div className="drop-in absolute right-0 top-[42px] z-[100] w-[260px] overflow-hidden rounded-[10px] border border-[#2b2b31] bg-[#0b0b0f]/97 shadow-2xl backdrop-blur-xl">
