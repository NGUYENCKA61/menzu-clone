...
export function CartButton({ count }: { count: number }) {
  return (
    <Link
      ...
      className="relative flex h-9 w-9 items-center justify-center rounded-[10px] border border-[#3a3a44] bg-[#2a2a32] text-neutral-300 transition-colors hover:border-white/20 hover:bg-[#343440] hover:text-white"
    >
