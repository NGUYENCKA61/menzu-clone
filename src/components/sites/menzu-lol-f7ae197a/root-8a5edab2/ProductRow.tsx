  ...
  return (
    ...
    >
      ...
      >
        ...
        {top ? (
          <span className="absolute left-1.5 top-1.5 z-10 inline-flex items-center gap-0.5 rounded-full border border-white/10 bg-[#0d0d12]/80 px-1.5 py-0.5 text-[8px] font-black uppercase tracking-wide text-[var(--menzu-accent)] backdrop-blur-md sm:left-2 sm:top-2 sm:gap-1 sm:px-2 sm:text-[9px]">
            <Crown size={10} strokeWidth={2.5} className="-ml-px shrink-0" aria-hidden />
            Top tháng
          </span>
        ) : null}
      </div>
