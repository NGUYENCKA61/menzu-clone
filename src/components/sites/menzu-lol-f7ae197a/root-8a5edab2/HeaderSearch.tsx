    ...
    <div ref={box} className="relative hidden md:block">
      <div className="relative md:w-44 lg:w-52 xl:w-56">
        {/* A well, not a frosted chip. The bar is #0f1015 and the field sits
            two steps lighter at #2a2a32: on a near-black bar the thing you
        ...
        <label className="relative flex h-9 items-center rounded-[10px] border border-[#3a3a44] bg-[#2a2a32] text-neutral-300 transition-colors focus-within:border-[var(--menzu-accent)]/70 focus-within:ring-[3px] focus-within:ring-[var(--menzu-accent)]/15">
          {navigating ? (
        ...
        {showList ? (
          <div className="drop-in absolute right-0 top-[42px] z-50 w-52 lg:w-64 xl:w-80 max-w-[calc(100vw-2rem)] overflow-hidden rounded-[10px] border border-[#2b2b31] bg-[#0b0b0f]/97 shadow-2xl backdrop-blur-xl">
            {shown.length === 0 ? (
