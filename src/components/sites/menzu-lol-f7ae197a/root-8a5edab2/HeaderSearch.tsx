      ...
      <div className="relative md:w-44 lg:w-52 xl:w-56">
        ...
        <label className="relative flex h-9 items-center rounded-[10px] border border-[#2b2b31] bg-[#17171c] text-neutral-300 transition-colors focus-within:border-[var(--menzu-accent)]/70 focus-within:ring-[3px] focus-within:ring-[var(--menzu-accent)]/15">
          ...
          <input
            ...
            onKeyDown={onKeyDown}
            // Names the act, not the goods. "Tìm hack, acc…" read as a filter
            // on the box; "Tìm kiếm mọi thứ…" promised more than the route
            // delivers — it searches tools, accounts and shelves, not news,
            // the wiki or orders. This one claims nothing and fits the 133px
            // the field has at 768px, its narrowest.
