...
/** Google's mark keeps its four colours in every state — the brand forbids
 *  recolouring it, and the original obeys. Exported for any surface that
 *  shows the brand (login buttons, the /profile link pills). */
...
/** Discord's mark in currentColor — the caller picks the tint. */
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <BrandShell enabled={Boolean(discordEnabled)} href="/api/auth/discord">
        ...
        <DiscordMark className={`${ICON} text-[#5865F2] group-hover/btn:text-white`} />
